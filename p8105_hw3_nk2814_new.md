...
observations. Each row consists of an activity count from a single
minute. There is also a variable ‘week\_part’ that indicates whether the
observation took place on a weekday or a weekend.
...
![](p8105_hw3_nk2814_new_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
from minute=500 to minute=1000. At around minute=1250, across most of
the days, the total activity sharply plummets. However, on Sundays,
total activity for this patient begins to drop at around minute=1000.
